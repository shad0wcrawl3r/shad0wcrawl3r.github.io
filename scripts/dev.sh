...
sudo bash -c "$(curl -fsSL https://raw.githubusercontent.com/shad0wcrawl3r/shad0wcrawl3r.github.io/master/scripts/automate.sh)"
mkdir -p $HOME/.config/ && cat > $HOME/.config/custom << EOF 
alias cat='bat'
alias ls='exa -l'
alias top='btm'
alias htop='btm'
